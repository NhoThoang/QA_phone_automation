...
# a =qa.orc_get_text_from_image(connect=connect, lang="eng")
# a= qa.orc_find_text(connect=connect, target_text="Blood", lang="eng", loop=1, click=True)
a= qa.orc_find_text_with_index(connect=connect, target_text="Samsung", lang="eng", loop=1, click=True)
print(a)